...
public class OrderStartedIntegrationEventHandler : IIntegrationEventHandler<OrderStartedIntegrationEvent>
{
    ...
    public Task Handle(OrderStartedIntegrationEvent @event)
    {
        ...
        IntegrationEvent paymentEvent = paymentSuccessFlag
            ...
            : new OrderPaymentFailedIntegrationEvent(@event.OrderId, "order failed");

        string infoMessage = $"OrderStartedIntegrationEventHandler in PaymentService is fired with PaymentSuccess: {paymentSuccessFlag}, orderId: {@event.OrderId}";
